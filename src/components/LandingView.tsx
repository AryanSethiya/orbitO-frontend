    ...
    <div className="min-h-screen flex flex-col justify-between relative overflow-x-hidden starfield-bg text-on-background bg-black select-none">
      ...
      <main className="flex-grow flex flex-col items-center justify-center pt-24 pb-12 px-4 md:px-margin-desktop relative">
        ...
        <div className="max-w-4xl w-full text-center relative z-10 flex flex-col items-center">
          ...
          <div className="relative w-full max-w-2xl aspect-[16/9] mb-8 group flex items-center justify-center">
            {/* Corner Brackets */}
            ...
            <div className="absolute bottom-[10%] left-[20%] w-[33%] h-[26%] flex flex-col items-center justify-center pointer-events-none text-center bg-black/75 backdrop-blur-[2px] p-2 border border-[#48ff48]/60 shadow-[0_0_20px_rgba(72,255,72,0.4)]">
              <div className="font-label-caps text-[8px] sm:text-[10px] text-[#48ff48]/90 uppercase tracking-widest font-mono flex items-center gap-1 mb-0.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#48ff48] animate-pulse"></span>
                <span>SYS.LINK // v2.4</span>
              </div>
              <span className="font-display-hero text-base sm:text-lg md:text-xl font-extrabold text-[#48ff48] drop-shadow-[0_0_12px_rgba(72,255,72,1)] tracking-wider uppercase leading-tight">
                WELCOME TO THE GAME
              </span>
              <span className="font-telemetry-sm text-[8px] sm:text-[10px] text-white/90 font-bold tracking-widest font-mono mt-0.5">
                &gt; INITIALIZE ORBIT &lt;
              </span>
            </div>
          </div>
